...
const CreateOrder = ({ token, userInfo }) => {
  ...
  // THIS IS WHERE I STORE ALL THE DATE ABOUT THE ORDER .... IF IM USING PRINTER HERE ARE THE INFO !!
  // TODO - ORDER ID as follow format: 23ndasd2-da123asd... to be very unique from the hole app and with this id to be generate the QR CODE !
